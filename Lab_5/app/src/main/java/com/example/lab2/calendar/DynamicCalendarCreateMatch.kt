...
import com.example.lab2.databinding.DynamicCalendarCreateMatchFragmentBinding
...
@AndroidEntryPoint
class DynamicCalendarCreateMatch : Fragment(R.layout.dynamic_calendar_create_match_fragment){

    private lateinit var binding: DynamicCalendarCreateMatchFragmentBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = DynamicCalendarCreateMatchFragmentBinding.bind(view)
    ...
    private fun setupMonthCalendar(
        ...
        monthCalendarView.dayBinder = object : MonthDayBinder<DayViewContainer> {
            ...
            override fun bind(container: DayViewContainer, data: CalendarDay) {
                container.day = data
                bindDate(data.date, container.textView, (data.position == DayPosition.MonthDate && data.date >= LocalDate.now()))
            }
        }
    ...
    private fun setupWeekCalendar(
        ...
        weekCalendarView.dayBinder = object : WeekDayBinder<WeekDayViewContainer> {
            ...
            override fun bind(container: WeekDayViewContainer, data: WeekDay) {
                container.day = data
                bindDate(data.date, container.textView, (data.position == WeekDayPosition.RangeDate && data.date >= LocalDate.now()))
            }
        }
