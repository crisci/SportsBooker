package it.polito.sportsbooker.common.calendar
...
import it.polito.sportsbooker.databinding.DynamicCalendarFragmentBinding
import it.polito.sportsbooker.databinding.MonthCalendarCalendarDayBinding
import it.polito.sportsbooker.view_models.CalendarVM
...
@AndroidEntryPoint
class DynamicCalendar : Fragment(R.layout.dynamic_calendar_fragment) {

    private lateinit var binding: DynamicCalendarFragmentBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = DynamicCalendarFragmentBinding.bind(view)
        ...
        if (requireActivity().componentName.className == "com.example.lab2.match.create_match.CreateMatchActivity") {
